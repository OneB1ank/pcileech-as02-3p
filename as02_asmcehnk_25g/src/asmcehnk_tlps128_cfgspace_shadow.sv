...
module asmcehnk_tlps128_cfgspace_shadow(
    input                   rst,
    input                   clk_pcie,
    input                   clk_sys,
    ...
    asmcehnk_mem_wrap i_asmcehnk_mem_wrap(
        .clk_pcie       ( clk_pcie                 ), // <-
    ...
    // PCIe REPLY:
    asmcehnk_cfgspace_pcie_tx i_asmcehnk_cfgspace_pcie_tx(
        .rst            ( rst                       ),  // <-
        .clk_pcie       ( clk_pcie                  ),  // <-
...
module asmcehnk_cfgspace_pcie_tx(
    input                   rst,
    input                   clk_pcie,
