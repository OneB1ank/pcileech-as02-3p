# AS02MC04 asmcehnk top-level constraints
# Equivalent role to AMDUSB4/src/asmcehnk_enigma_x1.xdc.
# Source material is the Taxi AS02 split XDC set, concatenated for the
# AMDUSB4/NeTV2-style src/ip project layout.
# Target part: xcku3p-ffvb676-2-e
...
# SFP28 Interfaces
# AS02 asmcehnk port policy:
#   physical SFP1 -> sfp_*[0] / MAC lane index 0 -> UDP transport
#   physical SFP2 -> sfp_*[1] / MAC lane index 1 -> intentionally idle
