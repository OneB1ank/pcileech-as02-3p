...
module asmcehnk_pcie_tlp_a7(
   ...
   // output                  o_valid,
    ...
    asmcehnk_tlps128_bar_controller i_asmcehnk_tlps128_bar_controller(
        .rst                   ( rst                    ),
        .clk                   ( clk_pcie               ),
    ...
    asmcehnk_tlps128_cfgspace_shadow i_asmcehnk_tlps128_cfgspace_shadow(
        .rst            ( rst                           ),
        .clk_pcie       ( clk_pcie                      ),
        .clk_sys        ( clk_sys                       ),
        .tlps_in        ( tlps_rx                       ),
    ...
    asmcehnk_tlps128_filter i_asmcehnk_tlps128_filter(
        .rst            ( rst                           ),
        .clk_pcie       ( clk_pcie                      ),
    ...
    asmcehnk_tlps128_dst_fifo i_asmcehnk_tlps128_dst_fifo(
        .rst            ( rst                           ),
        .clk_pcie       ( clk_pcie                      ),
        .clk_sys        ( clk_sys                       ),
    ...
    asmcehnk_tlps128_src_fifo i_asmcehnk_tlps128_src_fifo(
        .rst_pcie       ( rst                           ),
        .rst_sys        ( rst                           ),
        .clk_pcie       ( clk_pcie                      ),
        .clk_sys        ( clk_sys                       ),
    ...
    asmcehnk_tlps128_sink_mux1 i_asmcehnk_tlps128_sink_mux1(
        .rst            ( rst                           ),
        .clk_pcie       ( clk_pcie                      ),
        .tlps_out       ( tlps_tx                       ),
...
// ------------------------------------------------------------------------
module asmcehnk_tlps128_dst_fifo(
    input                   rst,
    input                   clk_pcie,
    input                   clk_sys,
